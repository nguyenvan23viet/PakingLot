            ...
            * { box-sizing: border-box; }
            ...
            .banner {
                ...
                background-image:
                    ...
                    url('https://commons.wikimedia.org/wiki/Special:FilePath/Parking_ticket_%2828019080047%29.jpg');
    ...
    <body>
        ...
        <nav class="navbar">
            ...
            <div class="nav-links">
                ...
                <a href="TicketServlet">Ve / Check-in / Check-out</a>
            ...
            <select class="nav-select" onchange="if(this.value) window.location.href=this.value;">
                ...
                <option value="TicketServlet">Ve / Check-in / Check-out</option>
        ...
        <div class="banner">
            ...
            <p>He thong Quan Ly Bai Gui Xe - Vai tro: Staff</p>
