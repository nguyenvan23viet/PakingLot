    ...
    <body>
        <div class="content">
            ...
            <form action="TicketServlet" method="get">
                ...
                <input type="text" name="keyword" placeholder="Tim theo bien so xe" value="<%= keyword%>"/>
                <select name="status">
            ...
            <div class="table-responsive">
                <table>
                    <tr>
                        ...
                        <th>Gio vao</th><th>Gio ra</th><th>Phi (VND)</th><th>Trang thai</th><th>Hanh dong</th>
                    </tr>
                    <%
                    ...
                    <tr id="tr_Ticket_<%= r[0]%>">
                        ...
                        <td>
                            <form action="TicketServlet" method="post" style="display:inline"
                                  onsubmit="return confirm('Xoa ve nay?');">
        ...
        String pageQS = "action=search&keyword=" + pageKeyword + "&status=" + pageStatus
                + "&fromDate=" + pageFrom + "&toDate=" + pageTo;
            %>
            <div>
                <% if (currentPage > 1) { %>
