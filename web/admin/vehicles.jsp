    ...
    <body>
        <div class="content">
            ...
            <form action="VehicleServlet" method="get">
                ...
                <input type="text" name="keyword" placeholder="Tim theo bien so hoac ten chu xe" value="<%= keyword%>"/>
            ...
            <div class="table-responsive">
                <table>
                    ...
                    <tr id="tr_Vehicle_<%= v.getVehicleID()%>">
                        ...
                        <td id="td_Owner_<%= v.getVehicleID()%>">
                            <%= (v.getOwnerName() != null) ? v.getOwnerName() : "(ID: " + v.getOwnerID() + ")"%>
                        </td>
                        <td id="td_OwnerPhone_<%= v.getVehicleID()%>"><%= (v.getOwnerPhone() == null) ? "" : v.getOwnerPhone()%></td>
                        <td>
                            <a href="VehicleServlet?action=showEdit&id=<%= v.getVehicleID()%>">Sua</a> |
                            <form action="VehicleServlet" method="post" style="display:inline"
                                  onsubmit="return confirm('Xoa xe nay?');">
        ...
        String pageKeyword = (keyword == null) ? "" : keyword;
            ...
            <%
                ...
                String fOwnerName = (request.getAttribute("formOwnerName") != null)
                        ? (String) request.getAttribute("formOwnerName")
                        : (editVehicle != null ? editVehicle.getOwnerName() : "");
                String fOwnerPhone = (request.getAttribute("formOwnerPhone") != null)
                        ? (String) request.getAttribute("formOwnerPhone")
                        : (editVehicle != null ? editVehicle.getOwnerPhone() : "");
            ...
            %>
            <h3><%= isEditMode ? "Cap Nhat Xe" : "Them Xe Moi"%></h3>
            <form action="VehicleServlet" method="post">
                ...
                <label>Ten chu xe (neu khach vang lai, khong co tai khoan):</label>
                <input type="text" name="ownerName" value="<%= (fOwnerName == null) ? "" : fOwnerName%>"/><br/><br/>

                <label>SDT chu xe:</label>
                <input type="text" name="ownerPhone" value="<%= (fOwnerPhone == null) ? "" : fOwnerPhone%>"/><br/><br/>

                <label>OwnerID (de trong neu la khach vang lai):</label>
